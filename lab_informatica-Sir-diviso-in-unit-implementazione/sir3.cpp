...
Epidemic::Epidemic(SIR sir_zero, float beta, float gamma, unsigned int days)
...
// corpo della funzione di dinamica
  std::vector<SIR>& Epidemic::dinamic() {
    ...
    //aggiungo una parte che mi restituisca la dinamica completa
    return record_;
  }
//corpo della funzione print
void Epidemic::print() {
    std::cout << "      ||####### S ###||### I ###||### R #######||\n";
